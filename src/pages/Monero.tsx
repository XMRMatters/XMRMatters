  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(251,146,60,0.04),transparent_70%)]" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 space-y-24">
          {/* Hero Section */}
          <div className="space-y-8 animate-fade-in-up">
            <div className="flex items-center justify-between gap-8 flex-col lg:flex-row">
              <div className="flex-1 space-y-6">
                ...
                <div className="flex gap-4 pt-4 flex-wrap">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300"
                  >
              ...
              {/* Hero Visual */}
              <div className="w-48 h-48 flex-shrink-0 bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-3xl flex items-center justify-center border border-orange-500/20 shadow-2xl shadow-orange-500/10">
          ...
          {/* Key Takeaway Box */}
          <div className="p-7 md:p-9 bg-gradient-to-r from-orange-500/15 to-orange-600/10 border border-orange-500/30 rounded-2xl animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              >
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="p-3 md:p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                    <p className="text-xs text-gray-400 mb-1">SENDER</p>
                    <p className="text-white font-mono text-xs md:text-sm">{bitcoinTransaction.sender}</p>
                    <p className="text-red-400 text-xs mt-2">⚠️ PUBLIC</p>
                  </div>
                  <div className="p-3 md:p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                    <p className="text-xs text-gray-400 mb-1">AMOUNT</p>
                    <p className="text-white font-mono text-xs md:text-sm">{bitcoinTransaction.amount}</p>
                    <p className="text-red-400 text-xs mt-2">⚠️ PUBLIC</p>
                  </div>
                  <div className="p-3 md:p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                    <p className="text-xs text-gray-400 mb-1">RECEIVER</p>
                    <p className="text-white font-mono text-xs md:text-sm">{bitcoinTransaction.receiver}</p>
                    <p className="text-red-400 text-xs mt-2">⚠️ PUBLIC</p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="p-3 md:p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                    <p className="text-xs text-gray-400 mb-1">SENDER</p>
                    <p className="text-white font-mono text-xs md:text-sm">{moneroTransaction.sender}</p>
          ...
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            ...
            <div className="space-y-4">
              {myths.map((item, idx) => (
                ...
                >
                  <div className="p-6 border border-gray-800/50 hover:border-orange-500/30 transition-all duration-300 rounded-2xl bg-gray-900/40 hover:bg-gray-900/60 group">
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex-1">
                        ...
                        {expandedMythIndex === idx && (
                          <p className="text-green-400 text-sm mt-2">✓ Reality: {item.reality}</p>
                        )}
                      </div>
                      <ChevronDown
              ...
              {timeline.map((item, idx) => {
                ...
                return (
                  <div key={idx} className="flex gap-8 items-center">
                    {isEven ? (
                      <>
                        <div className="flex-1 p-6 border border-orange-500/30 bg-orange-500/10 text-right rounded-2xl">
                      ...
                      <>
                        ...
                        <div className="flex-1 p-6 border border-orange-500/30 bg-orange-500/10 rounded-2xl">
                          <div className="font-bold text-orange-400 text-xs mb-2 uppercase tracking-wide">{item.year}</div>
                          <h3 className="font-semibold text-white text-base mb-3">{item.event}</h3>
                          <p className="text-gray-400 text-sm leading-relaxed">{item.desc}</p>
                        </div>
          ...
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {metrics.map((metric, idx) => {
                ...
                return (
                  <div key={idx} className="p-7 border border-orange-500/30 bg-orange-500/10 text-center rounded-2xl">
          ...
          {/* 5. Use Monero Right Now */}
          <div className="p-8 md:p-12 bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 rounded-3xl space-y-8 animate-fade-in-up" style={{ animationDelay: '600ms' }}>
            <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {quickStart.map((item, idx) => (
                <a
                  ...
                  className="p-6 border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 rounded-2xl cursor-pointer group hover:bg-purple-500/10"
                >
          ...
          {/* 6. Real Stories / Community Impact */}
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '700ms' }}>
            <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
              {stories.map((story) => (
                <div key={story.title} className="p-6 border border-green-500/30 hover:border-green-500/60 transition-all duration-300 bg-green-500/5 rounded-2xl">
          ...
          {/* How Privacy Works */}
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '800ms' }}>
            <div className="space-y-3">
            ...
            <div className="p-8 md:p-12 bg-gradient-to-br from-orange-500/10 via-gray-900/50 to-gray-900/50 border border-orange-500/20 rounded-3xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                {technicalFeatures.map((tech) => {
                  const Icon = tech.icon;
                  return (
                    <div key={tech.title} className="space-y-3">
          ...
          {/* 7. Deep Dive Common Questions */}
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '900ms' }}>
            <div className="space-y-3">
            ...
            <div className="space-y-4">
              {deepDiveQuestions.map((item, idx) => (
                <button
                  ...
                  className="w-full text-left"
                >
                  <div className="p-6 border border-blue-500/30 hover:border-blue-500/60 transition-all duration-300 bg-blue-500/5 rounded-2xl group">
          ...
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '1000ms' }}>
            <div className="space-y-3">
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  {privacyComparison.map((row) => (
                    <tr key={row.tech} className="border-b border-gray-800">
          ...
          <div className="p-8 md:p-12 bg-gradient-to-br from-indigo-500/10 to-indigo-600/5 border border-indigo-500/20 rounded-3xl space-y-8 animate-fade-in-up" style={{ animationDelay: '1100ms' }}>
            <div className="space-y-3">
          ...
          {/* 10. Community Spotlight */}
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '1200ms' }}>
            <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {spotlights.map((item) => (
                <div
                  key={item.name}
                  className="p-6 border border-gray-800/50 hover:border-orange-500/40 transition-all duration-300 rounded-2xl bg-gray-900/40 hover:bg-gray-900/60"
                >
          ...
          {/* 11. Security & Auditability */}
          <div className="p-8 md:p-12 bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 border border-cyan-500/20 rounded-3xl space-y-8 animate-fade-in-up" style={{ animationDelay: '1300ms' }}>
            <div className="space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {securityPoints.map((point) => (
                <div key={point.item} className="flex gap-4">
          ...
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '1400ms' }}>
            <div className="space-y-3">
            ...
            <div className="p-8 border border-yellow-500/30 bg-yellow-500/10 rounded-2xl">
              <div className="space-y-4">
          ...
          {/* Getting Started */}
          <div className="p-8 md:p-12 bg-gradient-to-br from-green-500/10 to-emerald-600/5 border border-green-500/20 rounded-3xl space-y-8 animate-fade-in-up" style={{ animationDelay: '1500ms' }}>
            <div className="space-y-3">
            ...
            <div className="flex gap-4 pt-4 flex-wrap justify-center">
              <button className="bg-green-600 hover:bg-green-700 text-white flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300">
                Create Free Account
                <ArrowRight className="w-4 h-4" />
              </button>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="border border-green-700 text-gray-300 hover:bg-green-800/20 flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300"
              >
          ...
          {/* FAQ Section */}
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '1600ms' }}>
            <div className="space-y-3">
          ...
          {/* Learning Resources */}
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '1700ms' }}>
            <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-6 border border-gray-800/50 hover:border-orange-500/40 transition-all duration-300 rounded-2xl group hover:bg-gray-900/60"
                >
                  <div className="space-y-4">
          ...
          {/* Final CTA */}
          <div className="p-8 md:p-12 bg-gradient-to-br from-orange-500/15 to-orange-600/10 border border-orange-500/30 rounded-3xl mb-16 text-center space-y-6 animate-fade-in-up" style={{ animationDelay: '1800ms' }}>
            <div className="space-y-3">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <button className="bg-orange-500 hover:bg-orange-600 text-white flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300">
                <span className="text-lg">Get Started</span>
                <ArrowRight className="w-5 h-5" />
              </button>
              <button className="border border-orange-500/40 text-gray-300 hover:bg-orange-500/10 flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300">
